...
const translations = {
  'en-US': {
    ...
    orderDepositBadge: 'Direct WhatsApp Payment Coordination with Admin',
    ...
    step3Title: 'Confirm & Coordinate Payment via WhatsApp',
    step3Desc: 'Message our admin on WhatsApp (+1 667 775 7597) to confirm your assignment pricing and choose your preferred offline payment method.',
    ...
    step6Title: 'Review & approve your completed work',
    step6Desc: 'Inspect the document, request free unlimited adjustments within 14 days, and achieve your target grade with complete confidence.',
    currencySymbol: '$',
    perPage: 'per page'
  },
  'en-GB': {
    ...
    step6Title: 'Review & approve your completed work',
    step6Desc: 'Review your submission, request free unlimited revisions within 14 days, and achieve your target grade with complete confidence.',
    currencySymbol: '£',
    perPage: 'per page'
  }
};
