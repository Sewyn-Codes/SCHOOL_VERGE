...
CREATE TABLE IF NOT EXISTS orders (
    ...
    stage VARCHAR(255) DEFAULT 'Document Received & Assigned to Tutor',
    days_ready VARCHAR(255) DEFAULT 'Ready in 3 days',
    admin_notes TEXT DEFAULT 'Tutor assigned and initial rubric review active',
    file_name VARCHAR(255),
    file_size VARCHAR(50),
    file_type VARCHAR(100),
    file_data TEXT,
    assignment_type VARCHAR(100) DEFAULT 'Essay',
    study_level VARCHAR(100) DEFAULT 'Undergraduate',
...
CREATE TABLE IF NOT EXISTS document_uploads (
    ...
    student_email VARCHAR(255) NOT NULL,
    student_name VARCHAR(255) NOT NULL,
    tutor_name VARCHAR(255) DEFAULT 'Sophia Mitchell',
